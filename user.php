...
/* 显示页面的action列表 */
$ui_arr = array('register', 'login', 'profile', 'daikuan', 'order_list', 'order_detail', 'address_list', 'collection_list',
...
//    var_dump($_POST);return;
    ...
    $profile = getUserInfoFromPost($_POST,$user_id);
    $profile['other'] = isset($other) ? $other : array();
//    var_dump($profile);return;
