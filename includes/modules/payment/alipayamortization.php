...
<div>
<span class="newroman font_16">请输入商享贷卡号</span>
...
<button class="font_20" style="background-color: #008CBA;" onclick="repaySuccess({$order['log_id']},{$order['down_payment']},'alipayamortization')">支付成功</button>
