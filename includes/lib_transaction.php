...
{
    $sql  = "SELECT friend_id, firend_type, friend_phone, friend_address, friend_company_address ".
...
function get_profile($user_id)
{
    ...
    $sql  = "SELECT user_name, birthday, sex, question, answer, actual_name, rank_points, pay_points,user_money, user_rank,".
             ...
             ,identity_card,id_begin_date,id_end_date,domicile_address,nationality,home_address,home_live_month,have_house,house_address,have_car
             ...
             ,company_name,company_address,company_type,company_industury,company_department,company_duty,company_entry_time,company_income_month
             ".
