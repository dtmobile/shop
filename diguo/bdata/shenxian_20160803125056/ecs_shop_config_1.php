...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','商城演示站','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','商城演示站','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','商城演示站','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','商城演示站','1');");
...
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','二环路西三段93号','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','1234567,7654317','1');");
...
E_D("replace into `ecs_shop_config` values('114','1','service_email','text','','','service@66mail.cn','1');");
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','028-87760898','1');");
...
E_D("replace into `ecs_shop_config` values('202','2','icp_number','text','','','蜀ICP12345678号','1');");
...
E_D("replace into `ecs_shop_config` values('218','2','stats_code','textarea','','','<script src=\"http://s11.cnzz.com/stat.php?id=1258434187&web_id=1258434187\" language=\"JavaScript\"></script>','1');");
...
E_D("replace into `ecs_shop_config` values('330','3','search_keywords','text','','','水果,牛奶,测试,威士忌,蔬菜','0');");
...
E_D("replace into `ecs_shop_config` values('9002','90','ecsdxt_user_name','text','','','xkfla','1');");
E_D("replace into `ecs_shop_config` values('9003','90','ecsdxt_pass_word','password','','','123456','1');");
E_D("replace into `ecs_shop_config` values('9004','90','ecsdxt_shop_mobile','text','','','13981750563','1');");
