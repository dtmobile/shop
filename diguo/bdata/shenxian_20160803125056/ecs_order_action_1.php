...
E_D("replace into `ecs_order_action` values('98','125','admin','1','0','0','0','','1470165432');");
E_D("replace into `ecs_order_action` values('99','125','admin','1','0','2','0','asdfasf','1470165438');");
E_D("replace into `ecs_order_action` values('100','125','admin','1','3','2','0','','1470165442');");
E_D("replace into `ecs_order_action` values('101','125','admin','5','5','2','0','asfasf','1470165448');");
E_D("replace into `ecs_order_action` values('102','125','admin','1','1','2','1','','1470165455');");
E_D("replace into `ecs_order_action` values('103','125','买家','5','2','2','0','','1470169513');");
